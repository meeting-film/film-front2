        ...
        methods: {
            ...
            confirmOrder () {
                let timer = null,
                    ...
                    _this = this;
                getData(process.env.BASE_URL + '/order/getPayInfo', 'post', params).then((res) => {
                    if (!res) return;
                    if (res) {
                        if (res.status == 0) {
                            ...
                            if (_this.qrcodeImg) {
                                ...
                                timer = setTimeout(() => {
                                    getData(process.env.BASE_URL + '/order/getPayResult', 'post', resultParams).then((res1) => {
                                        if (!res1) return;
                                        if (res1 && res1.data) {
        ...
        .right {
            ...
            .order-pay {
                ...
                .pay-btn {
                    ...
                    border-radius: 100px;
                    -webkit-box-shadow: 0 2px 10px -2px $baseColor;
                    box-shadow: 0 2px 10px -2px $baseColor;
                    &:hover {
                        background-color: $baseColorHover;
                        -webkit-box-shadow: 0 2px 10px -2px $baseColorHover;
                        box-shadow: 0 2px 10px -2px $baseColorHover;
                    }
                }
                .qrcode {
                    position: absolute;
